...
public class ShellService : IShellService
{
    ...
    public void ExecuteWithoutResult(string command)
    {
    ...
    public async Task<(int ExitCode, string? Output, string? ErrorOutput, Exception? Exception)> Execute(string command, Action<string>? outputReceived = null, Action<string>? errorOutputReceived = null)
    {
        try
        {
            var process = new Process
